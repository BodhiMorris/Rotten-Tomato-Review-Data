...
rotten_reviews_df.drop(rotten_reviews_df.index[95362:95363], inplace=True)
...
#print(averagedScore_df)
#averagedScore_df.to_csv('data/average.csv', index=False)
#---------------------------------------------------------------------------------------------------------------------------------------
...
id_df.to_csv('data/ids.csv', index=False)
